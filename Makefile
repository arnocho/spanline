...
record: build
	./$(BINARY) demo --cast docs/demo.cast --cast-width 118 --cast-height 36
...
stills: build
	./$(BINARY) demo --cast docs/stills.cast --cast-script stills --cast-width 118 --cast-height 36
	...
	@for triple in "reading:reading:3.1" "overview:look at this first:1.6" "incident:separated by:1.6" "impact:what that breaks:1.6" "keys:what the three views answer:1.6" "evidence:scroll:1.6"; do \
